...
- Lab ended sooner than expected due to /var/log/auth.log not having any 'Failed
  password' entries.
- Learned about the relationship between 'awk' 'sed' and 'cut'


---
 
## What Tripped me up (Anything that slowed you down or caused confusion)
- getting the 0 result, I had to asked what to do next when a 0 result was given
...
## Mental Model / Rules of Thumb (Simple rules you want burned into memory)


---

## Future Improvements / Variations (Optional: how this lab could be extended or improved)
